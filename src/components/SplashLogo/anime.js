...
const SPLASH_CONTAINER = '.dl-splash-container';
const SPLASH_LOGO = '.dl-splash-logo';
const SPLASH_CURTAIN = '.dl-splash-curtain';
const SPLASH_CURTAIN_LEFT = '.dl-splash-curtain-left';
const SPLASH_CURTAIN_RIGHT = '.dl-splash-curtain-right';
...
const timelineFrames = [
  ...
  {
    config: {
      targets: `${SPLASH_LOGO} .logo__set--1`,
      opacity: 1,
      duration: 2750,
    },
    offset: '+=1000',
  ...
  {
    config: {
      targets: `${SPLASH_LOGO} .logo__set--2`,
      fill: '#CC9851',
      duration: 2500,
    },
    offset: '-=2000',
